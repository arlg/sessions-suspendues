			...
			document.addEventListener(
				...
				function (event) {
					if (event.keyCode === 27) {
						...
						document
							.querySelectorAll(".cover-modal.active")
							.forEach(
								function (element) {
				...
				modal.addEventListener(
					...
					function (event) {
						...
						setTimeout(function () {
							...
							Object.keys(htmlStyles()).forEach(function (
								styleKey
							) {
	...
	twentytwenty.modalMenu = {
		...
		expandLevel: function () {
			...
			modalMenus.forEach(function (modalMenu) {
				var activeMenuItem = modalMenu.querySelector(
					".current-menu-item"
				);
			...
			_doc.addEventListener("keydown", function (event) {
				...
				if (
					...
					if (".menu-modal" === toggleTarget) {
						menuType = window.matchMedia("(min-width: 1000px)")
							.matches;
...
--------------------------------------------------------------------------------------------------- */
	...
	function twentytwentyToggleAttribute(
		element,
		attribute,
		trueVal,
		falseVal
